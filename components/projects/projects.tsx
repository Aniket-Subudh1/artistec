...
const projects: Project[] = [
  ...
  },
  {
    ...
    year: '2026',
    status: 'Live',
    gradient: 'linear-gradient(140deg, #0b1f1a 0%, #123a30 42%, #1b5a49 100%)',
    accentColor: '#34d399',
    textColor: '#dcfff5',
    chipStyle: 'bg-white/10 text-[#86efac] border border-[#10b981]/40',
    statusStyle: 'bg-[#34d399]/15 text-[#86efac] border border-[#34d399]/35',
